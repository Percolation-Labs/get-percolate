...
claim refreshes `heartbeat_at` — so the failure kept resetting the signal that
was supposed to reveal it. That is worse than having no view, because somebody
is watching it and drawing the wrong conclusion.
